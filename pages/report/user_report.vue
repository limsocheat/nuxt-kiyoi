		...
		data() {
			return {
                ...
                items: [
                	...
                	{
                		name: 'Purchase',
                		to: '/report/user_report/purchase',
                	},
                	{
                		name: 'Quotation',
                		to: '/report/user_report/quotation',
                	},
                	{
                		name: 'Transfer',
                		to: '/report/user_report/transfer',
                	},
                    {
                        name: 'Payment',
                        to: '/report/user_report/payment',
                    },
                	{
                		name: 'Expense',
                		to: '/report/user_report/expense',
                	},
                    {
                        name: 'Payroll',
                        to: '/report/user_report/payroll',
                    },
                ],
