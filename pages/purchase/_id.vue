		...
		<v-card id="printProduct">
			...
			<div class="px-5 pt-5">
				...
				<div>
					...
					<!-- <span class="productDetail--item" v-if="purchase.products">{{ purchase.products.supplier.name}}</span> -->
				</div>
				<div>
					<table class="tablePurchase">
						...
						<tr  v-if="purchase.products">
							<td class="tablePurchase--td">{{ purchase.id }}</td>
							<td class="tablePurchase--td">{{ purchase.products.name}}</td>
							<td class="tablePurchase--td">{{ purchase.products.cost}}</td>
						</tr>
						<tr>
