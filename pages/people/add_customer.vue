<template>
	<v-app>
		<v-card class="mx-5 my-5">
			...
			<v-row class="px-5">
				<v-col sm="6" cols="12">
					<label class="font-weight-bold" for="name">Customer Group</label>
					<v-select 
						outlined solo dense
						label="Product Name"
					></v-select>
				...
				<v-col sm="6" cols="12">
					<label class="font-weight-bold" for="">Tax Number</label>
					<v-text-field outlined solo dense label="Tax Number"></v-text-field>
				</v-col>
				<v-col sm="6" cols="12">
